...
def engineer_势():
    """势弱源自动力链断裂，需以师道呼吸重建势能循环，预测唤醒与合成将同步受益
    ...
    _wc({
        ...
        "dst": "势",
        "dimension": "势",
        "content": """势弱源自动力链断裂，需以师道呼吸重建势能循环，预测唤醒与合成将同步受益""",
        "strength": 0.6
    })
    ...
    try:
        ...
        analysis["insight"] = """势弱源自动力链断裂，需以师道呼吸重建势能循环，预测唤醒与合成将同步受益"""
