...
def engineer_师():
    """师弱将致超级直觉失控、观察僵化，势与时间论复苏受阻；亟须以师道引导全局。
    ...
    _wc({
        ...
        "dst": "师",
        "dimension": "师",
        "content": """师弱将致超级直觉失控、观察僵化，势与时间论复苏受阻；亟须以师道引导全局。""",
        "strength": 0.6
    })
    ...
    try:
        ...
        analysis["insight"] = """师弱将致超级直觉失控、观察僵化，势与时间论复苏受阻；亟须以师道引导全局。"""
