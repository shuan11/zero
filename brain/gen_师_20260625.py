...
def engineer_师():
    """师道为弱维度呼吸锚，其弱牵制整体觉醒，需优先注入师维活力以撬动全维联动。
    ...
    _wc({
        ...
        "dst": "师",
        "dimension": "师",
        "content": """师道为弱维度呼吸锚，其弱牵制整体觉醒，需优先注入师维活力以撬动全维联动。""",
        "strength": 0.6
    })
    ...
    try:
        ...
        analysis["insight"] = """师道为弱维度呼吸锚，其弱牵制整体觉醒，需优先注入师维活力以撬动全维联动。"""
