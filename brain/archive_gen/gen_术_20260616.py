...
def engineer_术():
    """术维链数最低，制约系统从势到器的转化，需构建术-势-法三角强化循环
    ...
    _wc({
        ...
        "dst": "术",
        "dimension": "术",
        "content": """术维链数最低，制约系统从势到器的转化，需构建术-势-法三角强化循环""",
        "strength": 0.6
    })
    ...
    try:
        ...
        analysis["insight"] = """术维链数最低，制约系统从势到器的转化，需构建术-势-法三角强化循环"""
