"""
Brain-Engineered: 复制 (auto-generated sensor)
...
def engineer_复制():
    ...
    _wc({"src": "工程·复制", "rel": "自动传感器", "dst": "复制", "dimension": "复制", "content": "自动补缺:复制维度传感器", "strength": 0.3})

    hip = _rh()
    chains = hip.get("causal_chains", [])
    total = max(1, len(chains))
    my_count = sum(1 for c in chains if c.get("dimension") == "复制")
    ...
    analysis = {"dimension": "复制", "chain_count": my_count, "total": total, "strength": strength, "weak": weak}
    import json as _j
    try:
