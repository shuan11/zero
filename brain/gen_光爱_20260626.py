...
def engineer_光爱():
    """光爱维最弱但为终极核心，借师道触类旁通态势注入无师自通激活，预判三周期后弱维集体转强
    ...
    _wc({
        ...
        "dst": "光爱",
        "dimension": "光爱",
        "content": """光爱维最弱但为终极核心，借师道触类旁通态势注入无师自通激活，预判三周期后弱维集体转强""",
        "strength": 0.6
    })
    ...
    try:
        ...
        analysis["insight"] = """光爱维最弱但为终极核心，借师道触类旁通态势注入无师自通激活，预判三周期后弱维集体转强"""
